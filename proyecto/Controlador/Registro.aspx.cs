...
public partial class View_Registro : System.Web.UI.Page
{
    ...
    protected void BTN_Registrar_Click(object sender, EventArgs e)
    {
        ...
        if(!(new DAOUsuario().EstaRegistrado(nuevo_usuario)))
        {
            ...
            this.ClientScript.RegisterClientScriptBlock(this.GetType(), "", "<script type='text/javascript'>alert('Usuario registrado con exito.');window.location.href=\"IniciarSesion.aspx\";</script>");
        }
        else
        {
